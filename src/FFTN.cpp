 ...
 * @brief Implementation of 2D and 1D Fast Fourier Fransformation (FFT) based on FFTW (see http://www.fftw.org)
 * 
 * The FFT method is used for upward continuation from plane to plane in frequency domain.
 * @version 1.0
 * @date 2019-09-03
 * 
